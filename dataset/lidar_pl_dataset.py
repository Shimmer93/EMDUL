...
class LiDARAssistedPseudoLabelingDataset(ReferenceDataset):
    ...
    def __getitem__(self, idx):
        ...
        while idx_unsup >= self.seq_lens_unsup[seq_idx_unsup]:
            ...
            seq_idx_unsup += 1
        unsup_path = self.data_path_ref if self.use_ref else self.data_path
        sample_unsup = self._build_sample(self.data_unsup[seq_idx_unsup], unsup_path, seq_idx_unsup, idx_unsup, global_idx_unsup)
